...
export function _unserializeImpl(value: any, type: InternalType | null | undefined, options?: SerializationOptions) {
...
function unserializeImplWithSerializer(value: any, type: InternalType | null | undefined, typeSerializer: Serializer | false | null | undefined, options?: SerializationOptions): any {
  ...
  if (serializer) {
    ...
    for (const property of Object.keys(value)) {
      niu[property] = _unserializeImpl(value[property], null, options);
    }
