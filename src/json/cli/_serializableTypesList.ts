 ...
 */
export function getDeclaredSerializableTypes(
...
function collectFromArray(arr: ts.ArrayLiteralExpression, checker: ts.TypeChecker, out: Set<ts.Symbol>): void {
...
function findSerializableCall(classDecl: ts.ClassDeclaration): ts.CallExpression | undefined {
