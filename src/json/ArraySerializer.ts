...
export class ArraySerializer<T = any> extends Serializer<T[]> {
  ...
  serialize(value: any, options?: SerializationOptions): any {
    ...
    if (this.isUndefinedOrNull(value)) {
      ...
      for (const i of value) {
        array.push(serializer ? serializer.serialize(i, options) : _serializeImpl(i, this.typeOrSerializer as any, options));
      }
      ...
      return _serializeImpl(value, this.typeOrSerializer as any, options);
    }
  }
  ...
  unserialize(json: any, options?: SerializationOptions): any {
    ...
    if (this.isUndefinedOrNull(json)) {
      ...
      for (const i of json) {
        array.push(serializer ? serializer.unserialize(i, options) : _unserializeImpl(i, this.typeOrSerializer as any, options));
      }
      ...
      return _unserializeImpl(json, this.typeOrSerializer as any, options);
    }
  }
}
