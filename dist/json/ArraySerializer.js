...
export class ArraySerializer extends Serializer {
    ...
    serialize(value, options) {
        ...
        if (this.isUndefinedOrNull(value)) {
            ...
            for (const i of value) {
                array.push(serializer ? serializer.serialize(i, options) : _serializeImpl(i, this.typeOrSerializer, options));
            }
            return array;
        }
        else if (serializer) {
            ...
            return _serializeImpl(value, this.typeOrSerializer, options);
        }
    }
    /**
    ...
    unserialize(json, options) {
        ...
        if (this.isUndefinedOrNull(json)) {
            ...
            const array = [];
            for (const i of json) {
                array.push(serializer ? serializer.unserialize(i, options) : _unserializeImpl(i, this.typeOrSerializer, options));
            }
            return array;
        }
        else if (serializer) {
            ...
            return _unserializeImpl(json, this.typeOrSerializer, options);
        }
    }
}
/**
